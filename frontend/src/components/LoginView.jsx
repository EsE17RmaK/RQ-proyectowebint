  ...
  return (
    <div className="login">
      ...
      <form onSubmit={handleSubmit} className="login__form">
        ...
        <p className="login__switch" style={{ textAlign: 'right', marginTop: '0.4rem' }}>
          <button type="button" onClick={() => onSwitchView('forgot')}>¿Olvidaste tu contraseña?</button>
        </p>
      ...
      <div className="login__social">
        <div className="login__social-links">
          <a href="https://wa.me/51999999999" target="_blank" rel="noreferrer" className="login__social-link__wsp">
            <img src="/assets/img/icon/icon-whatsapp.svg" alt="WhatsApp" className="login__social-img__wsp" />
      ...
      <p className="login__switch">
        ¿No tienes una cuenta? <button type="button" onClick={() => onSwitchView('register')}>Regístrate</button>
      </p>
    </div>
  );
}